...
const MapDirec = ({directions, setOpenDirection}) => {
    ...
    useEffect(() => {
        mapboxgl.accessToken = 'pk.eyJ1IjoiYWxpcmUiLCJhIjoiY2tsMmZkdGx1MWpzYzJvcDBqdjMxdzZqdSJ9.s4lIg_G5IZDxIZR1u9H5Rw';
